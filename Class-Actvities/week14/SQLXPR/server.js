...
app.get("/cast", function(req, res) {
  ...
  app.get("/coolness/:num", function(req, res) {

    var num = req.params.num;

    // If the main route is hit, then we initiate a SQL query to grab all records.
    // All of the resulting records are stored in the variable "result."
    connection.query("SELECT * FROM characters WHERE coolness = " + num, function(err, result) {
  ...
  app.get("/attitude/:att", function(req, res) {
    ...
    var att = JSON.stringify(req.params.att);
    ...
    var query = "SELECT * FROM characters WHERE attitude = " + att;
